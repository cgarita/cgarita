...
if ML >= 2.3 and dist < 55:
	...
	db = MySQLdb.connect (host = "10.0.50.36",user = "sentidos",passwd ="OvsSen",db = "autoeq")
...
if emailb == 4:#Desabilitado 19/09/2012 Se movio al servidor 10.10.128.175	
	if ML >= 4:
