			...
			#try:
				...
				#Guarda nuevo archivo
						...
						print 'Este sismo fue relocalizado'
	 	  				os.system('rm /tmp/tmpeqnew')
 		   				tmp = open('/tmp/tmpeqnew', 'wb')
